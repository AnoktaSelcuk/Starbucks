...
//  Starbucks
//
//  Created by Alperen Selçuk on 19.02.2022.
...
extension TileView {
    func style() {
        ...
        imageView.image                                     = UIImage(named: "meatless") // intrinsicContentSize ile beraber
        imageView.contentMode                               = .scaleAspectFit //image fullenecek.. fill olursa problem..
        imageView.clipsToBounds                             = true //tasarsa kesecek
    ...
    func layout() {
        ...
        NSLayoutConstraint.activate([//buraya view. ya da safearea olsa ne olacak
